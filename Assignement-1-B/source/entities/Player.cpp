...
Player::Player() : Entity(EntityType::PLAYER)
{
	...
	state = std::make_shared<PlayerStateComponent>(false, false, maxWood, 0, shootingCost, 0.f, shootCooldownTime, fireSpeed, velocity);
...
bool Player::intersects(Entity& other)
{
	...
	std::shared_ptr<ColliderComponent> otherCollider = other.getComponent<ColliderComponent>(ComponentID::COLLIDER);
