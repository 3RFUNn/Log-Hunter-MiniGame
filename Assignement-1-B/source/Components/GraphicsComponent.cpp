...
bool GraphicsComponent::isPlaying() {
	return getSpriteSheet()->getCurrentAnim()->isPlaying();
}

bool GraphicsComponent::isInAction() {
	return getSpriteSheet()->getCurrentAnim()->isInAction();
}
